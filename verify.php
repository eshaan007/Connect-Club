    ...
    if($data = $conn->query($query)){
        ...
        if($data->num_rows <= 0){
            ...
            if($conn->query($qry)){
                ...
                echo "<span style='color:green;'>Your email address has been verified. Your usename is '$u_name'. You change it later after login.<a href='https://keltagoodlife.co/Connect-Club/'>Click here to login</a></span>";
            }
            else{
        ...
        echo "<span style='color:red;'>Not verified. Please contact ConnectClub</span>";
    }
