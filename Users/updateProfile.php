<?php
	...
	if(isset($_SESSION['login_user_connect_club']) && isset($_REQUEST['u_name']) && isset($_REQUEST['cur_pass']) && isset($_REQUEST['newPass']) && isset($_REQUEST['newAga'])){
		...
		$new_pass_again = test_input($_REQUEST['newagainPass']);
